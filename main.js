...
const cardFlipAudio = new Audio('https://camsteph.github.io/Card-Match-Application/img/card-flip.mp3');
const cardMatchAudio = new Audio('https://camsteph.github.io/Card-Match-Application/img/bell_sound.mp3');
const errorNoiseAudio = new Audio('https://camsteph.github.io/Card-Match-Application/img/error-noise.mp3');
const gameAudio = new Audio('https://camsteph.github.io/Card-Match-Application/img/game_audio.mp3');
